namespace HomeWorkForModuleTest.Models.AnimalClasses.AnimalOrders.AnimalFamilies.AnimalSpecies
{
    ...
    public class JavaMouseDeer : Chevrotain
    {
        public JavaMouseDeer(double weight, double amountOfFoodRequiredPerDay, int age, Sex sex, ListOfChevrotain typeOfChevrotain)
            : base(weight, amountOfFoodRequiredPerDay, age, sex, typeOfChevrotain)
        {
        }

        public override string Name => nameof(JavaMouseDeer);
